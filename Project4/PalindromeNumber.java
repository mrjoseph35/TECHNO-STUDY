...
public class PalindromeNumber {
    ...
    public static int returnNum(int number) {
        String strSayi=String.valueOf(number);
        String yeniSayi="";
        for(int i=strSayi.length()-1;i>=0;i--){
            yeniSayi+=strSayi.charAt(i);
        }


        return Integer.parseInt(yeniSayi);
    }
    ...
    public static int palindromeNum(int num) {
        ...
        while (yenisayi!=returnNum(yenisayi)){
            yenisayi=yenisayi+returnNum(yenisayi);
